        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_Proveedores_Codigo", x => x.Codigo);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<int>(type: "int", nullable: false),
                    CodigoProveedor = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Productos_Proveedores_CodigoProveedor",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Productos_CodigoProveedor_CodigoProducto",
                table: "Productos",
                columns: new[] { "CodigoProveedor", "CodigoProducto" },
                unique: true);
